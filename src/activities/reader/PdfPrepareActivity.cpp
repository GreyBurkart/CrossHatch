...
#if defined(SIMULATOR) || defined(CROSSINK_QEMU)
bool PdfPrepareActivity::acceptanceObserveFailure(PdfPrepareAcceptanceObservation* const observation) const {
...
bool pdfObserveActivePrepareFailure(PdfPrepareAcceptanceObservation* const observation) {
  return activePdfPrepareActivity != nullptr && activePdfPrepareActivity->acceptanceObserveFailure(observation);
}
#endif
