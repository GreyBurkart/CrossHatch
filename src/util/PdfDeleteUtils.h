...
using DirectoryDeleteSessionPtr = std::unique_ptr<DirectoryDeleteSession, DirectoryDeleteSessionDeleter>;
...
Result deletePdfBookNoPathAlloc(DirectoryDeleteSession& session, std::string_view sourcePath);
