...
class RecentBooksStore : public PersistableStore<RecentBooksStore> {
 ...
 public:
  ...
  bool activatePathMigration(const std::string& oldPath, const std::string& newPath, const std::string& oldCachePath,
                             const std::string& newCachePath, bool keepInRecents = true);
  bool verifyPathMigration(const std::string& oldPath, const std::string& newPath, bool keepInRecents = true) const;
  bool verifyPersistedPathMigration(const std::string& oldPath, const std::string& newPath, bool keepInRecents) const;
