...
class ReaderDocument final : public ReflowDocument {
 public:
  ...
  std::string getCoverBmpPath(bool = false, bool = false) const override { return {}; }
  bool generateCoverBmp(bool = false, const GfxRenderer* = nullptr, int = 0, bool = false) const override {
    return false;
  }
