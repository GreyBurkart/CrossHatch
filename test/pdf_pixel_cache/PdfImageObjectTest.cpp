...
TEST(PdfImageObjectDecode, AcceptsSampleDomainDecodeEndpointsForTwoBitIndexedImages) {
  static constexpr char normal[] = "<< /W 4 /H 1 /CS [/Indexed /DeviceGray 3 <0055AAFF>] /BPC 2 /F /Fl /D [0 3] >>";
  static constexpr char inverted[] = "<< /W 4 /H 1 /CS [/Indexed /DeviceGray 3 <0055AAFF>] /BPC 2 /F /Fl /D [3 0] >>";
...
TEST(PdfImageObjectDecode, EnforcesColorSpaceSpecificDecodeUpperEndpoints) {
  static constexpr char graySampleMaximum[] = "<< /W 1 /H 1 /CS /DeviceGray /BPC 8 /F /Fl /D [0 255] >>";
  static constexpr char rgbSampleMaximum[] = "<< /W 1 /H 1 /CS /DeviceRGB /BPC 8 /F /Fl /D [255 0 255 0 255 0] >>";
...
TEST(PdfImageObjectDecode, KeepsMalformedDecodeMembersFatal) {
  static constexpr char nonNumeric[] = "<< /W 1 /H 1 /CS /DeviceGray /BPC 8 /F /Fl /D [0 /NotANumber] >>";
  static constexpr char wrongShape[] = "<< /W 1 /H 1 /CS /DeviceGray /BPC 8 /F /Fl /D [0 1 0] >>";
...
TEST(PdfImageObjectDecode, DefersRawDecodeEndpointValidationUntilIndirectColorSpaceResolution) {
  static constexpr char unsupportedRgb[] = "<< /W 1 /H 1 /CS 21 0 R /BPC 8 /F /Fl /D [255 0 255 0 255 0] >>";
  static constexpr char supportedRgb[] = "<< /W 1 /H 1 /CS 21 0 R /BPC 8 /F /Fl /D [1 0 1 0 1 0] >>";
  ...
  for (const bool supported : {false, true}) {
    ...
    EXPECT_EQ(descriptor.disposition, supported ? PdfImageDisposition::Ready : PdfImageDisposition::OmitUnsupported);
    if (supported) {
...
TEST(PdfImageObjectDecode, ValidatesIndexedDecodeAfterIndirectBaseColorSpaceResolution) {
  static constexpr char dictionary[] = "<< /W 4 /H 1 /CS [/Indexed 22 0 R 3 <0055AAFF>] /BPC 2 /F /Fl /D [0 3] >>";
  ArenaStorage storage;
  PdfObjectArena arena;
  uint16_t rootIndex = PDF_INVALID_INDEX;
  std::array<uint8_t, 768> palette{};
...
TEST(PdfImageObjectDecode, DoesNotConstrainIndexedHighValueToTheOneBitSampleCardinality) {
  static constexpr char dictionary[] = "<< /W 2 /H 1 /CS [/Indexed /DeviceGray 3 <0055AAFF>] /BPC 1 /F /Fl /D [0 1] >>";
  ArenaStorage storage;
  PdfObjectArena arena;
  uint16_t rootIndex = PDF_INVALID_INDEX;
  std::array<uint8_t, 768> palette{};
...
TEST(PdfImageObjectFilters, StructurallyValidatesOverCapPipelinesBeforeOmittingWithoutStorage) {
  static constexpr char validOverCap[] = "<< /W 1 /H 1 /CS /DeviceGray /BPC 8 /Filter [/AHx /A85 /AHx /A85 /Fl] >>";
  static constexpr char malformedOverCap[] = "<< /W 1 /H 1 /CS /DeviceGray /BPC 8 /Filter [/AHx /A85 /AHx /A85 7] >>";
...
TEST(PdfImageObjectValidation, KeepsSyntacticallyCorruptFilterMetadataFatal) {
  static constexpr char nonNameFilter[] = "<< /W 1 /H 1 /CS /DeviceGray /BPC 8 /F [/FlateDecode 42] >>";
  static constexpr char nonDictionaryParameters[] = "<< /W 1 /H 1 /CS /DeviceRGB /BPC 8 /F /DCT /DP 7 >>";
